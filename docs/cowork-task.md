...
{
  "thread_id": "t-abc123",
  "org": "<one of your configured org tags>|external|unknown",
...
org: one of the org tags configured in pending.json's context block, plus
external and unknown. Use org_domain_map to map sender domains to an org.
...
org tag (external and unknown are tags, not entities). works_at links a
