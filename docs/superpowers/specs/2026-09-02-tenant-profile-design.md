...
| File | Occurrences |
|---|---|
| `mcpbrain/enrich_prompt.md` | 13 lines: Marcus Reyes, Dana Okafor, Franz / The Church Co, Optus Stadium, Centrepoint Church → Capes Community Church, `[ACC]`, "Donna K, ACC finance lead", "ACC" vs "ACCI", `marcus-reyes` |
| `plugin/agents/enrich-batch.md` | the same 13 — **generated**, kept byte-identical by `bin/sync_agents.py` |
| `mcpbrain/cowork/enrichment.md` | 3: "Dana" = "Dana Okafor", `marcus-reyes` ×2 |
| `mcpbrain/routines/meeting-packs.md` | 1: attendee list `Dana Okafor,Sam Admin` |
| `plugin/skills/mcpbrain-bootstrap/SKILL.md` | 1: `(e.g. "Centrepoint")` |
| `mcpbrain/wizard/index.html` | 3 — see below |
| `mcpbrain/chunking.py:130` | `slugify` docstring: `"Marcus Reyes"`, `"ACC (National)"` |
...
| `mcpbrain/query_router.py:100` | expansion example `"Marcus Reyes Centrepoint Maddington"` |
