...
from mcpbrain import config, drain, extractor_driver, graph_write, prepare  # noqa: E402
...
def run_dry_run(store, *, home: "Path | str | None", run_claude=None,
    ...
    real claude_pool fire (Nexus); tests pass a fake. Returns counts before/after,
    the drain summaries, and an idempotency flag.
    """
...
def _print_report(result: dict, home: str | None) -> bool:
    ...
    overall = activity and idempotent
    print()
