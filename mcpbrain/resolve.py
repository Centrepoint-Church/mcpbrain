...
would give better recall for non-overlapping names (e.g. "Dana" vs "J. Okafor")
...
def canonical_key(name: str) -> str:
    ...
    'Ps Dana' and 'Dana' share a key; 'Chané' and 'Chane' share a key.
    """
...
def _tokens(name) -> set:
    ...
    key = canonical_key(name)            # 'dana-okafor'
...
def write_time_dedup_check(name: str, entity_type: str,
    ...
    aliases ('Dana' vs 'J. Okafor') but needs entity vectors that don't exist
