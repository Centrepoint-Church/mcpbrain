...
critique, voice-check.

This prompt is self-contained: it names the exact MCP tools to call and does
not depend on resolving any skill, command, or file outside this text.
...
This pipeline uses two MCP tools registered by mcpbrain:
