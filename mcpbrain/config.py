...
def spool_home(home=None) -> Path:
    ...
    Single canonical implementation: drain.py's own _home() now just delegates
    here rather than duplicating the resolution logic (§9C).
    """
...
def schema_grounding_enabled(home) -> bool:
    ...
    'Dana Okafor' extracted from 'Ps Dana') while rejecting names invented out
...
def expand_params(home) -> dict:
    ...
    return {
        ...
        "char_budget": int(c.get("expand_char_budget", 4000)),
    }
