...
def _seed_duplicate_entities(store):
    ...
    store.upsert_entity("ps-dana", "Ps Dana", "person", org="Acme")
    store.upsert_entity("dana", "Dana", "person", org="Acme")
    return ["ps-dana", "dana"]
...
def test_resolve_not_due_skips_then_due_runs_again(tmp_path):
    ...
    store.upsert_entity("ps-marcus", "Ps Marcus", "person", org="Acme")
    store.upsert_entity("marcus", "Marcus", "person", org="Acme")
